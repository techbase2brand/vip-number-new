...
const GlobalBasicResult = ({ results, nextPage, viewLoadMore,loadmore }) => {
  const { queryParams } = useGetQueryParams();
  const panelImg = process.env.NEXT_PUBLIC_IMAGES;
  return (
    <>
      {results.length !== 0 && (
        <section className="defaultResult-section-os GoldResult-section-os">
          <AppliedTags queryParams={queryParams} />
          <div className="container-os">
            <div className="featured-number-heading-os sorted-filter-title">
              <MainHeading
                MainHeading="Basic Number"
...
export default GlobalBasicResult;
