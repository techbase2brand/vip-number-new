...
const AdvanceSearch = ({ results, nextPage, searchNextUrl,loadmore }) => {
        ...
        <section className="AdvanceSearch-section-os default-section-os">
          ...
          <div className="container-os">
            <div className="featured-number-heading-os sorted-filter-title">
              <MainHeading
                MainHeading=" Advance Search  Number"
            ...
            <div>
              {results && results.length > 0 ? (
                <div>
                  <div className="grid xl:grid-cols-5 lg:grid-cols-3 gap-3 mg:grid-cols-3  grid-cols-2">
                    {results.map((product) => {
